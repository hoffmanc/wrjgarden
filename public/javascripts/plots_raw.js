function paintPlots(canvas) {
    ...
    $.each($('ul#reservedPlots li'), function(idx, li){
        var plotNo = $(li).attr('data-number');
        var plotCoord = plotCoords[plotNo];
        initLayer(plotNo, canvas, plotCoord[0], plotCoord[1], "rgba(200, 0, 0, 0.5)")
    });
